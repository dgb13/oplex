...
import { CashSessionExcelService } from './cash-session-excel.service.js';
...
@Module({
  providers: [CashRegistersService, CashSessionsService, CashSessionExcelService],
  exports: [CashRegistersService, CashSessionsService, CashSessionExcelService],
})
